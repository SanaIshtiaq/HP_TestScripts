...
public class createPropertybyPO 
{
	...
	{		
      ...
      //******************************************************************************************  
	    //id = location
	    driver.findElement(By.id("location")).sendKeys("Berlín-Mitte, Germany");
	    // 6 id = property_state          ... dropdown
	    //new Select(driver.findElement(By.id("property_state"))).selectByIndex(rand.nextInt(15)); //.selectByVisibleText("Hessen");
	    driver.findElement(By.id("property_state")).click();
	    
 		// 7 id = property_city           ... dropdown
	    //new Select(driver.findElement(By.id("property_city"))).selectByIndex(rand.nextInt(2)); //.selectByVisibleText("Biblis");
	    ...
	    */
	    ...
	    // .........................................................................................
	    //preview button
	    driver.findElement(By.id("preview_property_btn")).click();
