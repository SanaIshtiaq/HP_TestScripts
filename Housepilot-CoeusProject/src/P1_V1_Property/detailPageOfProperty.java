...
public class detailPageOfProperty 
{
	public static void main(String [] args)
	{
		try
		{
			...
			driver.findElement(By.xpath("/html/body/div/div[2]/div[2]/div[3]/div/div[3]/table/tbody/tr["+var2+"]/td[4]/a")).click();
		   
			Assert.assertTrue("Ansicht Immobilie", true);
			
			String propertyTitle = driver.findElement(By.xpath("/html/body/div/div[2]/div[2]/div[3]/div/div[1]/table/tbody/tr[1]/td[2]")).getText();
			System.out.println("we are on the detail page of : "+propertyTitle);
		}
		catch(Exception e)
		{
