...
public class createProperty
{
	...
	{		
		...
		driver.findElement(By.xpath("/html/body/div/div[2]/div[2]/div[3]/div/div[1]/a")).click();
	   ...
	   //Invalid input for zip code
        for(int k = 0 ; k<3 ; k++)
        {
    	    ...
    	    // testintg .**************************************************************
    	    driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
    	    driver.findElement(By.xpath("/html/body/div[1]/div[2]/div[2]/div[3]/div/form/div[1]/div[5]/div")).click();
	    ...
	    new Select(driver.findElement(By.id("property_city"))).selectByIndex(rand.nextInt(2));
