...
public class TenantProfile 
{
	...
	{     
         ...
         driver.findElement(By.id("email")).sendKeys("test3@coeus-solutions.de");
         ...
         //click on profile section at top menu
         driver.findElement(By.xpath("/html/body/div[1]/nav/section/ul[1]/li[3]")).click();
         driver.findElement(By.xpath("/html/body/div[1]/nav/section/ul[1]/li[3]/ul/li[4]/a")).click();
	...
	public void contactTab()
	{
	    ...
	    Msg =  driver.findElement(By.xpath("/html/body/div[7]/h3")).getText();
	 	...
	 	//click on body at contact tab
	 	driver.findElement(By.xpath("/html/body/div[2]/div[3]/div[1]")).click();
	 	
	 	//tab 2
	 	//street
	 	driver.findElement(By.xpath("/html/body/div[2]/div[3]/div[1]/div/div[2]/div[1]/form/div[1]/div/label[1]/input")).clear();//driver.findElement(By.id("street")).clear();
	 	driver.findElement(By.xpath("/html/body/div[2]/div[3]/div[1]/div/div[2]/div[1]/form/div[1]/div/label[1]/input")).sendKeys(RandomStringUtils.randomAlphabetic(4)); //driver.findElement(By.id("street")).sendKeys(RandomStringUtils.randomAlphabetic(4));// +RandomStringUtils.randomAlphabetic(4));
	 	
	 	//house number
	 	driver.findElement(By.xpath("/html/body/div[2]/div[3]/div[1]/div/div[2]/div[1]/form/div[1]/div/label[2]/input")).clear(); //driver.findElement(By.id("house_number")).clear();
	 	driver.findElement(By.xpath("/html/body/div[2]/div[3]/div[1]/div/div[2]/div[1]/form/div[1]/div/label[2]/input")).sendKeys("1"+rand.nextInt(5));  //driver.findElement(By.id("house_number")).sendKeys("1"+rand.nextInt(5)); //+rand.nextInt(5));
	 		 	
	 	//additional address
	 	driver.findElement(By.xpath("/html/body/div[2]/div[3]/div[1]/div/div[2]/div[1]/form/div[2]/label/input")).clear();//driver.findElement(By.id("address")).clear();
	 	driver.findElement(By.xpath("/html/body/div[2]/div[3]/div[1]/div/div[2]/div[1]/form/div[2]/label/input")).sendKeys(RandomStringUtils.randomAlphabetic(4));//driver.findElement(By.id("address")).sendKeys("ad"+RandomStringUtils.randomAlphabetic(4));
	...
	*/
	...
	{
		// direct click on 3rd tab
		 driver.findElement(By.id("user-living-information-header")).click();
